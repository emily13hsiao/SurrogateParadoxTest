...
```
We will go through an example using the main function in the **SurrogateParadoxTest** package. First, install the package from CRAN and load it. This package imports the **MonotonicityTest** package; if you see error messages about a fortran compiler, please see: https://cran.r-project.org/bin/macosx/tools/
